###
# From https://github.com/IASIAI/gym-connect-four/blob/fbb504596ff868acaf909b29b4f52f0cb0dd6e1e/examples/sample_nn.py
# Written by Andrei Suiu and Vlad Adomnicai
###
...
from gym_connect_four.connect_four_env import ConnectFourEnv, Player, ResultType, SavedPlayer
...
class ScoreLogger:
	...
	def add_score(self, score: int, run: int, exploration_rate: float, memory_size: int, refresh=False):
		...
		print(
			f"Run {run:3}: (avg: {mean_score:2.3f}, last{self._N}_avg: {last_20mean:2.3f}, expl: {exploration_rate:1.3}, "
